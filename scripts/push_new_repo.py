...
for i in range(1500):
    ...
    # Định dạng Alpaca chuẩn không có metadata dư thừa
    alpaca_item = {
...
print("Đang đóng gói và đẩy lên Hugging Face REPO MỚI...")
hf_dataset = Dataset.from_list(formatted_dataset)
repo_name = "linhhuong-office-dataset-v2"  # TÊN REPO MỚI TINH!

try:
    hf_dataset.push_to_hub(repo_name, private=False)
    print(f"✅ Đẩy dữ liệu thành công! Tên repo mới là: {repo_name}")
